...
CREATE INDEX IF NOT EXISTS idx_tasks_participant_ids_gin ON public.tasks USING GIN(participant_ids);
CREATE INDEX IF NOT EXISTS idx_tasks_approver_ids_gin ON public.tasks USING GIN(approver_ids);
